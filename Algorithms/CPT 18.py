...
def recognize(images):
    ...
    chars = "" # result string
    net = loadFromPickle("C:\Python27\Captcha_Cracker\Networks\CPT 18.txt")
    ds = loadFromPickle("C:\Python27\Captcha_Cracker\Datasets\CPT 18.txt")
    for im in images:
...
def run(path, number):
    ...
    for image in imageFiles:
        ...
        #saveIM(images, "CPT", "C:\Python27\Captcha_Cracker\Segmented_Characters\CPT 18\\")
...
#run("C:\Python27\Captcha_Cracker\Captcha Images\CPT 18", 62)
