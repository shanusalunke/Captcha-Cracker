...
def recognize(images):
    ...
    chars = "" # result string
    net = loadFromPickle("C:\Python27\Captcha_Cracker\Networks\CPT 12.txt")
    ds = loadFromPickle("C:\Python27\Captcha_Cracker\Datasets\CPT 12.txt")
    for im in images:
...
def run(path, number):
    ...
    for image in imageFiles:
        ...
        name = 'Image' + str(i)
        #saveIM(images, name, 'C:\Python27\Captcha_Cracker\Segmented_Characters\CPT 12\\')
        i = i+1
...
#run("C:\Python27\Captcha_Cracker\Captcha Images\CPT 12",1)
