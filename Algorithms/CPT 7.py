...
def recognize(images):
    ...
    chars = "" # result string
    net = loadFromPickle("C:\Python27\Captcha_Cracker\Networks\CPT 7.txt")
    ds = loadFromPickle("C:\Python27\Captcha_Cracker\Datasets\CPT 7.txt")
    for im in images:
...
#run("C:\Python27\Captcha_Cracker\Captcha Images\CPT 7",1)
